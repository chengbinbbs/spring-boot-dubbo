...
public class RedisConfig extends CachingConfigurerSupport{
    ...
    @Bean
    public RedisTemplate<String, Address> redisTemplate2(RedisConnectionFactory factory) {
        RedisTemplate<String, Address> template = new RedisTemplate<String, Address>();
